...
TARGET = NPClient.dll
HEADERS = NPClient.hpp logging.hpp joystick.hpp sig_data.hpp util.hpp
SOURCES = NPClient.cpp logging.cpp joystick.cpp sig_data.cpp util.cpp
...
TEST_SOURCES = joystick_test.cpp logging.cpp joystick.cpp util.cpp
